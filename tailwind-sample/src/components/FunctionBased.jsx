...
const FunctionBased = () => {
    ...
    return (
        <div>
            ...
            <div className='w-100 h-40 bg-gray-800 rounded-sm flex shadow-xl shadow-sky-400/100 justify-evenly items-center transition duration-200  delay-200 ease-in hover:scale-120  '>
                {display ? (
